...
\begin{document}
    ...
    \section{教育经历}
    \begin{cvitems}
        \item[本科生] \textbf{上海交通大学} 四年级 \rightnote{上海}
        
        电子信息与电气工程学院~计算机科学与技术\rightnote{预计 2019--2023}

        数学科学学院~数学与应用数学\rightnote{2018--2019}
    
        \tip{核心学积分} 87.25/100\quad \tip{CET6} 545 (口语: B+)
    ...
    \begin{cvitems}
        ...
        \begin{subcvitems}
            ...
            \item[\faCaretSquareORight\hskip1pt] 校内社群 \href{https://sjtug.org}{\textsf{SJTUG}} 成员，向\TeX{}中文社区 \textsf{C\TeX{}-org} 贡献代码\,\href{https://github.com/CTeX-org/learnlatex.github.io}{\faGithubSquare~\sffamily learnlatex.github.io}，开展 \LaTeX{} 校内讲座 \href{https://github.com/sjtug/sjtulib-latex-talk}{\faGithubSquare~\sffamily sjtulib-latex-talk}。
    ...
    \begin{cvitems}
        \item \textbf{全国大学生物联网竞赛} 鸿蒙特别创新奖~全国一等奖 \rightnote{2022}
    ...
    \begin{cvitems}
        ...
        \tip{相关工作} \LaTeX{} 幻灯片模板 \href{https://github.com/sjtug/SJTUBeamer}{\faGithubSquare~\sffamily SJTUBeamer} \faStar~\textsf{309}~主要维护者之一。
